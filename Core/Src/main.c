...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : DO_BMS_EN_Pin DO_BMS1_Pin */
  GPIO_InitStruct.Pin = DO_BMS_EN_Pin|DO_BMS1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : DI_BTN_OK_PM1_ZX_Pin */
  GPIO_InitStruct.Pin = DI_BTN_OK_PM1_ZX_Pin;
  ...
  /*Configure GPIO pin : DI_BTN_UP_PM2_ZX_Pin */
  GPIO_InitStruct.Pin = DI_BTN_UP_PM2_ZX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
