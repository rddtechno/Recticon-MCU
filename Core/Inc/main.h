...
#define DO_FUEL_EN_Pin GPIO_PIN_4
#define DO_FUEL_EN_GPIO_Port GPIOA
...
#define DO_RS232_EN_CLK_EN_HUM_Pin GPIO_PIN_8
#define DO_RS232_EN_CLK_EN_HUM_GPIO_Port GPIOC
#define DIO_AUX0_Pin GPIO_PIN_9
#define DIO_AUX0_GPIO_Port GPIOC
#define DIO_AUX1_Pin GPIO_PIN_8
#define DIO_AUX1_GPIO_Port GPIOA
#define DIO_AUX1_EXTI_IRQn EXTI9_5_IRQn
#define DO_OPI_PWR_Pin GPIO_PIN_11
#define DO_OPI_PWR_GPIO_Port GPIOA
#define DI_FAN_IOEXP_RST_Pin GPIO_PIN_12
#define DI_FAN_IOEXP_RST_GPIO_Port GPIOA
#define DI_DOOR_SPI3_CS0_Pin GPIO_PIN_15
#define DI_DOOR_SPI3_CS0_GPIO_Port GPIOA
...
#define DO_LVD_BTS_SPI3_CS1_Pin GPIO_PIN_2
#define DO_LVD_BTS_SPI3_CS1_GPIO_Port GPIOD
#define DO_LVD_VSAT_Pin GPIO_PIN_3
#define DO_LVD_VSAT_GPIO_Port GPIOB
...
#define DIO_AUX2_Pin GPIO_PIN_9
#define DIO_AUX2_GPIO_Port GPIOB
