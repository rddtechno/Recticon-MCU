...
#define DI_IOEXP_INTA_Pin GPIO_PIN_4
#define DI_IOEXP_INTA_GPIO_Port GPIOB
#define DI_IOEXP_INTA_EXTI_IRQn EXTI4_IRQn
#define DI_IOEXP_INTB_Pin GPIO_PIN_5
#define DI_IOEXP_INTB_GPIO_Port GPIOB
#define DI_IOEXP_INTB_EXTI_IRQn EXTI9_5_IRQn
